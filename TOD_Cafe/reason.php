...
<body>
    ...
    {
        session_start();
        $_SESSION['user_Delete'] = $_GET['user_Delete']; 
                            ...
                            <html>
                                ...
                                <body>
                                    <div class='container'>
                                        ...
                                        <div class='title'>
                                            <h2>Mr $user,</h2>
                                            <h3>Your account has been deleted by our Admin. The reason is $reason.</h3>
                                            <h3>From: TOD Cafe</h3>
                                        </div>
                                    </div>
                                </body>
    ...
    ?>
    <form action = "reason.php" method = "post" class="position-absolute top-50 start-50 translate-middle w-75 p-3">
