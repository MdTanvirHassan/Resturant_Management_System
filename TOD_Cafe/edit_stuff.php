...
if(isset($_POST['edit_profile']))
{
    ...
    $sql = "UPDATE persons_stuff SET $option ='$change' WHERE username='$user'";
                            ...
                            <html>
                                ...
                                <body>
                                    <div class='container'>
                                        ...
                                        <div class='title'>
                                            <h2>Mr $user,</h2>
                                            <h3>Your account have been updated by our Admin. Let's hope you like your job. If you have any query, Let us know.</h3>
                                            <h3>From: TOD Cafe</h3>
                                        </div>
                                    </div>
                                </body>
